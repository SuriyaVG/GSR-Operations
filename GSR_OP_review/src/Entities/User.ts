...
export class AuthorizationService {
  ...
  static hasPermission(
    ...
    if (specificPermission) {
      // Special case: financial_ledger read should only be allowed for ADMIN and FINANCE
      if (resource === 'financial_ledger' && action === 'read') {
...
export const User = {
  ...
  async me(): Promise<User> {
    // Use AuthService for consistent database-driven authentication
