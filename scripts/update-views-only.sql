-- Update Database Views Only
-- This script only updates the views without dropping them first

-- Update vw_batch_yield with proper calculated fields
...
-- Update vw_customer_metrics with simplified reorder prediction algorithm
